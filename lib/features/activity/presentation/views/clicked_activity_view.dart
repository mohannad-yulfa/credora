...
class ClickedActivityScreen extends StatefulWidget {
  final List<ClickedActivity> clickedActivities;

  const ClickedActivityScreen({super.key, required this.clickedActivities});

  @override
  State<ClickedActivityScreen> createState() => _ClickedActivityScreenState();
}

class _ClickedActivityScreenState extends State<ClickedActivityScreen>
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Offers and activities you have visited',
                  maxLines: 2,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${widget.clickedActivities.length}',
                  style: TextStyle(
  ...
  Widget _buildActivities() {
    if (widget.clickedActivities.isEmpty) {
      return _buildEmptyState();
    }

    return Column(
      children: List.generate(widget.clickedActivities.length, (index) {
        return _AnimatedClickedCard(
          index: index,
          animationController: _animationController,
          child: _buildActivityCard(widget.clickedActivities[index]),
        );
      }),
    );
  }

  Widget _buildActivityCard(ClickedActivity activity) {
    return Container(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Your visited offers will appear here.',
...
class _AnimatedClickedCard extends StatelessWidget {
  final int index;
  final AnimationController animationController;
  final Widget child;

  const _AnimatedClickedCard({
    required this.index,
